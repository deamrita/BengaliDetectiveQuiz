...
public class BomkeshActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bomkesh2);
        ...
        button_skip.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent=new Intent(BomkeshActivity2.this,BomkeshActivity3.class);
