...
public class FeludaActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feluda9);
        ...
        button_skip.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(FeludaActivity9.this, FeludaActivity10.class);
